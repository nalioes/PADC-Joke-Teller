 ...
 */
public class TViewFragment extends Fragment {
    public static final String BARG_USERNAME = "bundle_data";
    public static final String BARG_VIEW = "third_view";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.third_view_fragment, container, false);
